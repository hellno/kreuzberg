...
// alef:hash:c755385dcb176fa787a9ca478cf3c184e208c39f4e1fd166855f7a37a0ff2afe
...
impl ChunkingConfig {
    ...
    fn resolve_preset(&self) -> ChunkingConfig {
        let core_self = kreuzberg::ChunkingConfig {
            max_characters: self.max_characters,
            overlap: self.overlap,
            trim: self.trim,
...
fn get_embedding_backend_registry() -> String {
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("resolve_preset", method!(ChunkingConfig::resolve_preset, 0))?;
    ...
    module.define_module_function(
        ...
        function!(get_embedding_backend_registry, 0),
    )?;
