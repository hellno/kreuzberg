...
// alef:hash:a3590148cb6600ee86370a0536470f2b6aebab642f8be99dec67d76c054bc3eb
...
public static class KreuzbergLib
{
    ...
    {
        var result = NativeMethods.GetEmbeddingBackendRegistry();
        if (result == IntPtr.Zero)
        {
            var err = GetLastError();
            if (err.Code != 0)
    ...
    /// </summary>
    public static ChunkingConfig ChunkingConfigResolvePreset()
    {
        var result = NativeMethods.ChunkingConfigResolvePreset();
        var jsonPtr = NativeMethods.ChunkingConfigToJson(result);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.ChunkingConfigFree(result);
