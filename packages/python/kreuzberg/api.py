...
# alef:hash:a3877b5206a62894c36c269b9ced7666423ba3bd1d38cae7eefb2e8a22a01dc3
...
from ._kreuzberg import SupportedFormat, TesseractConfig, LlmConfig, ChunkingConfig, OcrQualityThresholds, LanguageDetectionConfig, ImageExtractionConfig, ImagePreprocessingConfig, EmailExtractionResult, ChunkingResult, StringBufferPool, PostProcessorConfig, HierarchyConfig, Metadata, Keyword, EmbeddingConfig, YakeParams, TreeSitterProcessConfig, OcrElementConfig, OcrConfig, HtmlOutputConfig, TreeSitterConfig, ExtractionConfig, DocumentStructure, PageConfig, RakeParams, TokenReductionConfig, PageBoundary, EmailConfig, LayoutDetectionConfig, PdfConfig, AccelerationConfig, ContentFilterConfig, ExtractionResult, KeywordConfig, TextAnnotation, Element, ByteBufferPool
...
def get_embedding_backend_registry() -> str:
    ...
    return _rust.get_embedding_backend_registry()
