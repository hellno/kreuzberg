...
// alef:hash:eb1b8be8e472b3622a42fe965c1c648a368d7d60544eed81db2f56e239ef1c87
...
impl WasmChunkingConfig {
    ...
    #[wasm_bindgen(js_name = "resolvePreset")]
    pub fn resolve_preset(&self) -> WasmChunkingConfig {
        kreuzberg::ChunkingConfig::from(self.clone()).resolve_preset().into()
    }
...
#[wasm_bindgen(js_name = "getEmbeddingBackendRegistry")]
