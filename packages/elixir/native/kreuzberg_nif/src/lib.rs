...
// alef:hash:ab8bb2f970c9ac2f98debd3769d2741715da94b2e42b6110a20548ac480e9ad6
...
pub fn get_embedding_backend_registry() -> String {
    String::from("[unimplemented: get_embedding_backend_registry]")
}
...
pub fn chunkingconfig_with_chunker_type(obj: ChunkingConfig, chunker_type: ChunkerType) -> ChunkingConfig {
    kreuzberg::ChunkingConfig::from(obj).with_chunker_type(chunker_type.into()).into()
}
...
pub fn chunkingconfig_with_prepend_heading_context(obj: ChunkingConfig, prepend: bool) -> ChunkingConfig {
    kreuzberg::ChunkingConfig::from(obj).with_prepend_heading_context(prepend).into()
}

#[rustler::nif]
pub fn chunkingconfig_with_topic_threshold(obj: ChunkingConfig, threshold: f32) -> ChunkingConfig {
    kreuzberg::ChunkingConfig::from(obj).with_topic_threshold(threshold).into()
}

#[rustler::nif]
pub fn chunkingconfig_resolve_preset(obj: ChunkingConfig) -> ChunkingConfig {
    kreuzberg::ChunkingConfig::from(obj).resolve_preset().into()
}
