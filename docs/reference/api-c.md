...
#### kreuzberg_get_embedding_backend_registry()
...
```c
const char* kreuzberg_get_embedding_backend_registry();
```
...
```c
KreuzbergChunkingConfig kreuzberg_resolve_preset();
```
