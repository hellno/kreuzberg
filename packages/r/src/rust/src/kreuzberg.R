...
# alef:hash:174051abf2e89edb80577fa2dcb2367c05e0483d54e89202ffdc92f638191ee2
...
#' @export
get_embedding_backend_registry <- function() {
  .Call("kreuzberg_get_embedding_backend_registry")
}
