...
# alef:hash:e9d7e000fe749b2359519958c262806ba53e1b6d8a5d2ffbdcf6f4ed87e063c9
...
defmodule Kreuzberg.Native do
  ...
  def get_embedding_backend_registry, do: :erlang.nif_error(:nif_not_loaded)
  ...
  def chunkingconfig_with_chunker_type(_obj, _chunker_type), do: :erlang.nif_error(:nif_not_loaded)
  def chunkingconfig_with_sizing(_obj, _sizing), do: :erlang.nif_error(:nif_not_loaded)
  def chunkingconfig_with_prepend_heading_context(_obj, _prepend), do: :erlang.nif_error(:nif_not_loaded)
  def chunkingconfig_with_topic_threshold(_obj, _threshold), do: :erlang.nif_error(:nif_not_loaded)
  def chunkingconfig_resolve_preset(_obj), do: :erlang.nif_error(:nif_not_loaded)
